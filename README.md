...
# Run the container
docker login
docker run -it -d -p 6006:6006 -p 8888:8888 -w /home/ -v /home/jdegange/SynDataGenerator/:/home/ --name=jld_synth_data_gen --runtime=nvidia tensorflow/tensorflow:latest-gpu-jupyter
docker exec -it jld_synth_data_gen bash
...
wget https://raw.githubusercontent.com/yskmt/pb/master/pb.py
'''
